...
// ReplicaGroupRenderer is a Renderer which combines the 'top abstraction' of all pods.
...
var ReplicaGroupRenderer = ConditionalRenderer(renderKubernetesTopologies,
	MakeMap(
